            ...
            <div class="bg-white rounded-2xl shadow-2xl p-8 relative overflow-hidden">
                <form id="registerForm" method="POST" action="{{ route('register') }}">
                    ...
                    <div x-show="step === 1" x-transition:enter="transition ease-out duration-300"
                        ...
                        <p class="text-sm text-gray-500 mb-6 text-center">Selecciona una opción para configurar tu cuenta
                        </p>

                        <!-- Banner si ya viene con un rol preseleccionado -->
                        <div x-show="role === 'cook'" x-cloak
                            class="mb-5 p-3.5 bg-purple-50 border border-purple-200 rounded-xl text-xs text-purple-800 flex items-center gap-2.5">
                            <div>
                        ...
                        <div x-show="role === 'delivery_driver'" x-cloak
                            class="mb-5 p-3.5 bg-blue-50 border border-blue-200 rounded-xl text-xs text-blue-800 flex items-center gap-2.5">
                            <div>
                        ...
                        <div class="grid grid-cols-1 gap-4 mb-6">
                            ...
                            <label class="relative cursor-pointer group block">
                                <input type="radio" name="role" value="customer" x-model="role" @change="roleError = false"
                                    class="peer sr-only">
                                <div class="border-2 rounded-2xl p-5 transition-all flex items-center space-x-4"
                                    ...
                                    <div class="ml-auto text-orange-500 transition-opacity"
                                        :class="role === 'customer' ? 'opacity-100' : 'opacity-0'">
                            ...
                            <!-- Opción 2: Cocinero -->
                            <label class="relative cursor-pointer group block">
                                <input type="radio" name="role" value="cook" x-model="role" @change="roleError = false"
                                    class="peer sr-only">
                                <div class="border-2 rounded-2xl p-5 transition-all flex items-center space-x-4"
                                    ...
                                    <div class="flex-1">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span
                                                class="text-[11px] bg-purple-100 text-purple-700 font-bold px-2 py-0.5 rounded-full">Cocinero</span>
                                        </div>
                                        <p class="text-sm text-gray-500">Vende tus platos y genera ingresos</p>
                                    </div>
                                    <div class="ml-auto text-purple-500 transition-opacity"
                                        :class="role === 'cook' ? 'opacity-100' : 'opacity-0'">
                                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd"
                                                d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                                clip-rule="evenodd" />
                            ...
                            <!-- Opción 3: Repartidor -->
                            <label class="relative cursor-pointer group block">
                                <input type="radio" name="role" value="delivery_driver" x-model="role"
                                    @change="roleError = false" class="peer sr-only">
                                <div class="border-2 rounded-2xl p-5 transition-all flex items-center space-x-4"
                                    ...
                                    <div class="flex-1">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span
                                                class="text-[11px] bg-blue-100 text-blue-700 font-bold px-2 py-0.5 rounded-full">Repartidor</span>
                                        </div>
                                        <p class="text-sm text-gray-500">Entrega pedidos en tu vehículo</p>
                                    </div>
                                    <div class="ml-auto text-blue-500 transition-opacity"
                                        :class="role === 'delivery_driver' ? 'opacity-100' : 'opacity-0'">
                                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd"
                                                d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                                clip-rule="evenodd" />
                        ...
                        <div x-show="roleError" x-cloak
                            class="mb-4 p-3 bg-red-50 border border-red-200 rounded-xl text-xs text-red-600 flex items-center gap-2">
                    ...
                    <div x-show="step === 2" x-cloak x-transition:enter="transition ease-out duration-300"
                        ...
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <span class="text-xs font-semibold px-2.5 py-1 rounded-full flex items-center gap-1" :class="{
                            ...
                            @error('email')
                                <div class="mt-2 p-3 bg-red-50 border border-red-200 rounded-xl text-xs text-red-700 space-y-1">
                                    ...
                                    <p class="text-gray-600">
                                        ...
                                        <a href="{{ route('login') }}"
                                            class="text-purple-600 font-bold underline hover:text-purple-800">
                                            Inicia sesión aquí
                        ...
                        <div class="mb-6">
                            ...
                            <p class="text-xs text-gray-500 mt-1.5 flex items-center">
                                <span class="mr-1">💡</span> 10 dígitos con código de área (sin 0 ni 15). Usado para
                                enviarte notificaciones por WhatsApp.
                            </p>
                            @error('phone')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                    ...
                    <div x-show="step === 3" x-cloak x-transition:enter="transition ease-out duration-300"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                ...
                                <button type="button" onclick="togglePasswordVisibility('password', 'eyeIconRegisterPass')"
                                    ...
                                    <svg id="eyeIconRegisterPass" class="w-5 h-5" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="relative">
                                ...
                                <button type="button"
                                    onclick="togglePasswordVisibility('password_confirmation', 'eyeIconRegisterConfirm')"
                                    class="absolute inset-y-0 right-0 pr-4 flex items-center text-gray-400 hover:text-gray-600 focus:outline-none"
                                    title="Mostrar / Ocultar contraseña">
                                    <svg id="eyeIconRegisterConfirm" class="w-5 h-5" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="flex space-x-3">
                            ...
                            <button type="submit" id="btnSubmitRegister"
                                ...
                                <svg id="btnSubmitRegisterSpinner" class="hidden animate-spin h-5 w-5 text-white"
                ...
                <div id="registerLoadingOverlay"
                    class="fixed inset-0 bg-black/60 z-50 hidden flex-col items-center justify-center backdrop-blur-sm transition-all duration-300">
                    <div
                        class="bg-white p-8 rounded-2xl shadow-2xl flex flex-col items-center max-w-sm w-full mx-4 text-center">
                        <div
                        ...
                        <p class="text-sm text-gray-500">Estamos configurando tu perfil y tus accesos. Por favor no cierres
                            ni recargues esta ventana.</p>
                    </div>
                </div>
