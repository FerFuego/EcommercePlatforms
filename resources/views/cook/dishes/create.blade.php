                ...
                <form action="{{ route('cook.dishes.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-8 space-y-6">
                        ...
                        <div class="pt-4 border-t border-gray-100">
                            <label
                                class="flex items-center p-4 bg-purple-50 rounded-xl cursor-pointer hover:bg-purple-100 transition border-2 border-purple-200">
                                <input type="checkbox" name="is_schedulable" value="1" checked
                                    class="w-6 h-6 text-purple-600 rounded-lg">
                                <div class="ml-4">
                                    <span class="block font-bold text-purple-900 text-lg">Permitir Programación 📅</span>
                                    <span class="text-sm text-purple-700">Habilita este plato para ser pedido con
                                        anticipación para fechas futuras.</span>
                                </div>
                            </label>
                        </div>
                    </div>
