...
@section('content')
    ...
    <button onclick="openFeedbackModal()" class="fixed bottom-8 right-2 z-50 bg-gradient-to-r from-purple-600 to-pink-600 text-white w-14 h-14 rounded-full shadow-2xl hover:scale-110 transition-transform flex items-center justify-center group">
